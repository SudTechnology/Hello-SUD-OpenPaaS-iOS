...
extern NSString * _Nonnull const SUDRT_KEY_AUDIO_SPEAKER_ON;
/// Whether to mix audio with other apps and other games (other games within this APP)
extern NSString * _Nonnull const SUDRT_KEY_AUDIO_MIX_WITH_OTHER;
/// Whether to respect the device's mute switch setting
extern NSString * _Nonnull const SUDRT_KEY_AUDIO_OBEY_MUTE_SWITCH;

@protocol SUDRTGameQueryAudioOptionsHandle <NSObject>
...
@protocol SUDRTGameQueryAudioOptionsListener <NSObject>

- (void)onQueryAudioSession:(id<SUDRTGameQueryAudioOptionsHandle>)handle appId:(NSString *)appId options:(NSDictionary *)options;

@end

@protocol SUDRTGameAudioSession <NSObject>
