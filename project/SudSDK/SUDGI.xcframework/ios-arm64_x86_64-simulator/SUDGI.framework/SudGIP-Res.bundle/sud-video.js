...
if (_rt.Video && _rt.createVideo !== undefined) {
  ...
  var _VideoProxy = function _VideoProxy(obj) {
    ...
    _rt.callCustomCommand(
      ...
      obj.controls,
      obj.showProgress,
      obj.showProgressInControlMode,
      video.backgroundColor,
      obj.autoplay,
      obj.loop,
      obj.muted,
      obj.obeyMuteSwitch,
      obj.enableProgressGesture,
      obj.enablePlayGesture,
      obj.showCenterPlayBtn,
      video.underGameView,
      obj.autoPauseIfNavigate,
      obj.autoPauseIfOpenNative,
    )
  }
  ...
  _VideoProxy.prototype.requestFullScreen = function (direction) {
    let video = this.video
    return new Promise((resolve, reject) => {
      let result = _rt.callCustomCommandSync(
        'sud-video-requestFullScreen',
        video.instanceID,
        direction,
      )
  ...
  console.log('sud crateVideo1')
  _rt.createVideo = function (obj) {
    console.log('sud crateVideo2')
    return new _VideoProxy(obj)
  }
  console.log('sud crateVideo3')
  /*
    添加Video的坐标和宽高属性
    */
  ...
  var __sudControlVideo = function (instanceID, action, args) {
    ...
    console.log('sudControlVideo: ' + action + ' for instanceID: ' + instanceID)
    switch (action) {
      case 'pause':
